...
%\begin{figure}[H]
%    \centering
%    \includegraphics[height=0.9\textwidth]{ASAP/media/(FM-PKS) PeakSat ST-DL V1 Alignment Prism.pdf}
%    \caption{Alignment prism orthogonal view}
%    \label{fig:cad_00}
%\end{figure}
% \end{landscape}
...
%\begin{figure}[h]
%    \centering
%    \includegraphics[width=0.5\textwidth]{ASAP/media/cad02_st_rot+x1'.png}
%    \caption{PeakSat illustration, $+x$ side. From this side we have line of sight to all the surface of the alignment prism, which is $0.5 cm^2$}
%    \label{fig:cad01}
%\end{figure}
%
%
%\begin{figure}[h]
%    \centering
%    \includegraphics[width=0.5\textwidth]{ASAP/media/cad03_yside_FoV.png}
%    \caption{PeakSat illustration, $+y$ side. From this side a cut-off to the panels PCB will be made in order to have access. Using the current setup we have line of sight to a $0.5 cm^2$ surface of the alignment prism.}
%    \label{fig:cad03}
%\end{figure}
...
%\begin{figure}[h]
%    \centering
%    \includegraphics[width=\textwidth]{ASAP/media/cad04_3dFov.png}
%    \caption{Overview of PeakSat, showing the final position of the star tracker with respect to the frame of the satellite.}
%    \label{fig:cad04}
%\end{figure}
